...
public class PhysicalControllerAirplane_Input : BaseAirplane_Input
{
    ...
    {
        // process main inputs
        pitch = Input.GetAxis("JoystickY");
        roll = Input.GetAxis("JoystickX");
        yaw = Input.GetAxis("JoystickRudder");
